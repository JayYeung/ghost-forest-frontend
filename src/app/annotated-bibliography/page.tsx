                ...
                <section className="w-full max-w-4xl bg-white/70 backdrop-blur-lg rounded-2xl shadow-2xl p-10 border border-gray-100">
                    ...
                    >
                        ...
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            ...
                            Education Focal Point of Public Science Project.”{" "}
                            ...
                            “Chronolog,” a project that allows community members
                            to contribute photos documenting change in the
                            environment over time, which acts as an example of
                            an interactive and community-focused approach to
                            ghost forest education. This article is valuable to
                            our project because it emphasizes the importance of
                            community engagement and local responses to
                            environmental change. While it does not directly
                            analyze policymaking, it shines a light on how local
                            communities respond to its effects — even
                        ...
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            ...
                            provides valuable context on North Carolina's long
                            history of drainage, development, and deregulation,
                            and highlights a lack of public and political
                            accountability within legislative processes. This
                            source is essential to our group project because it
                            places these recent policy changes as part of a
                            larger trend of decisions that contributes to
                            ecological degradation, specifically the formation
                            of ghost forests. It adds narrative depth to our
                            project by providing direct testimony from those
                            opposed to the policies, and allows us to see the
                            extent of the conflict as well as the perspectives
                            of affected communities. Additionally, it offers
                            insight into how public discussion around
                            environmental change often ignores historical
                            precedents, a theme we can explore while we analyze
                            political corruption. By using Castagno's article
                            along with geographical data and zoning records, we
                            can more effectively show how ghost forests are
                            consequences of long-term political and economic
                            choices.
                        </div>
                        ...
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            ...
                            <em>
                                Political Donations Decide NC's Environmental
                                Future.
                            </em>{" "}
                        ...
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            ...
                            “How Corruption Undermines Global Climate Efforts.”{" "}
                            <em>Transparency International</em>, 11 Feb. 2025,{" "}
                            <a
                            ...
                            those directly pertinent to North Carolina's coastal
                            policy landscape. This limitation can be solved by
                            further research into North Carolina's regional
                            environmental policies and residents' anecdotes on
                            how environmental policies and sea-level rising
                            shape each other over time. As our project seeks to
                            discover how the rise of ghost forest resulting from
                            political failures exacerbates environmental
                            degradation in North Carolinian coastal communities,
                            the positive correlation between corruption and
                            weakened environmental health and mitigations as
                            proven in this source acts as a critical foundation
                            to base our hypothesis on. Overall, Gverdtsiteli and
                        ...
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            ...
                            Cover Change.” <em>Science</em>, vol. 342, no. 6160,
                            15 Nov. 2013, pp. 850–853. Google Earth Engine.
                            <br />
                            ...
                            Engine. Hansen et al.'s dataset allows for precise
                            tracking of forest loss across regions and time. In
                            this project, the data plays a key role in mapping
                            ghost forests in the Albemarle-Pamlico region,
                            revealing how forest loss corresponds with specific
                            shifts in policy and land use. The major strength of
                            this source lies in its scientific rigor and
                            accessibility — the data is open and reproducible,
                            making it ideal for transparent visual analysis.
                            However, while the data clearly illustrates where
                            forest loss is occurring, it does not by itself
                            explain why these changes are happening. It also
                            does not directly capture the role of policy,
                            lobbying, or human influence. To overcome this
                            limitation, we combine this dataset with policy
                            analysis and historical records, allowing us to
                            create a more complete story about how political
                            forces have contributed to environmental outcomes.
                        </div>

                        {/* Hibbs */}
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            <strong>Hibbs, Mark.</strong> “Judge Boyle Rejects
                            Preliminary Injunction in Wetlands Case.”{" "}
                            <em>Coastal Review</em>, June 2024,{" "}
                            <a
                            ...
                            and the "waters of the United States." Judge Boyle
                            rejected the notion stating that "White has failed
                            to show that he is likely to succeed on the merits
                            of either of his claims," and being at odds with
                            public interest. For our ghost-forest project, this
                            article supplies very recent legal context. It
                            confirms that despite there are many core federal
                            protections that cover much of North Carolina
                            wetlands, there is still much constant debate and
                            fight over these vulnerable lands. This article
                            highlights how various stakeholders shape wetland
                            policy, such as the Pacific Legal Foundation and the
                            Southern Environmental Law Center and wildlife
                            federation. Each of these lobbying entities could
                            accelerate or decelerate the enactment of
                            conservation policies. Although the Coastal Review
                            is a nonprofit newsroom affiliated with the North
                            Carolina Coastal Federation, the organization the
                            story offers limited detail on hydrology or
                            ecological impacts and relies on court filings
                            rather than environmental analysis. In any case,
                            this article provides a clear and concise narrative
                            of a pivotal district level court decision that
                            reveals the forces behind the legalities behind
                            environment and policy-making.
                        </div>

                        {/* Igelman */}
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            <strong>Igelman, Jack.</strong> “'Ghost Forests' Are
                            Creeping Across NC's Coast at an Alarming Rate.
                            Researchers Are Trying to Stop Them."{" "}
                            <em>Carolina Public Press</em>, 12 Aug. 2022,{" "}
                            <a
                            ...
                            ghost forest proliferation across North Carolina's
                            coastline, combining scientific research insights
                            with compelling firsthand accounts from local
                            communities. It outlines the ecological and cultural
                            significance of coastal forests to North Carolina
                            residents and tribal communities, the rapid loss in
                            Down East coastal ecosystems due to rising sea
                            levels and saltwater intrusion, and the limited
                            support and readiness from policymakers regarding
                            effective mitigation strategies. Summarizing the
                            complex ecological phenomena of ghost forest
                            formation through engaging narratives by people
                            across different sectors who care about the issue,
                            including scientific researchers, local residents,
                            and seafood industry workers, Igelman persuasively
                            enhances public awareness of multiple perspectives
                            on North Carolina's ghost forests. This aligns with
                            a crucial objective for our digital humanities
                            project, as we are not trying to prove causation but
                            raising awareness of ghost forest as a rarely known
                            yet stark signature of climate change, and how it's
                            influenced by political factors and perpetuating
                            loss to local communities. By incorporating direct
                            quotes from credible sources, Igelman aids us in
                            establishing our authoritativeness and emotional
                            connection with our audience. Moreover, Igelman
                            underscores the socioeconomic implications of ghost
                            forests in North Carolina, highlighting how ghost
                            forests exacerbate existing vulnerabilities among
                            coastal communities, including fishermen, Down East
                            residents, and Indigenous people. Despite offering
                            abundant real-life accounts and descriptive quotes
                            regarding ghost forests, Igelman lacks rigorous
                            analytical data, limiting the article's utility in
                        ...
                        {/* Moore */}
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            <strong>Moore, Andrew.</strong> “Ask an Expert: What
                            Are Ghost Forests?”{" "}
                            ...
                            of what makes the article helpful, showcasing what's
                            missing and where our project serves a purpose. This
                            source supports our effort to create a narrative
                            that's both grounded and nuanced, helping us balance
                            environmental science with the political and social
                            aspects of ghost forest emergence in North Carolina.
                        </div>
                        ...
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            ...
                            overview of the U.S. Supreme Court's Sackett v. EPA
                            decision and its ramifications for wetland
                            ...
                            Carolina's environmental regulations. Ultimately,
                            this source deepens our argument that ghost forests
                            are not just natural signs of sea-level rise, but
                            visible outcomes of political and legal choices that
                            prioritize industry interests over the strength of
                        ...
                        <div style={{ textIndent: "-2em", paddingLeft: "2em" }}>
                            ...
                            Emergency of 'Ghost Forests' From 1986 to 2016 and
                            Their Enviro-Cultural Impacts on the Communities of
                            Down East, North Carolina, USA.”{" "}
                            ...
                            .<br />
                            Peck's senior honors thesis critically examines the
                            progression and impacts of ghost forests in the Down
                            East communities of North Carolina using GIS-based
                            remote sensing methods. Analyzing NDVI values
                            derived from Landsat imagery over a thirty-year
                            span, Peck identifies significant forest loss,
                            linking it primarily to saltwater intrusion driven
                            by rising sea levels and climate-induced extreme
                            weather events. This study's value lies in its
                            professional and comprehensive quantitative
